...
import { Calendar, ExternalLink, FileText, HardDrive, Server, Wifi } from 'lucide-react';
  ...
  return (
    <Layout>
      <div className="mb-8 animate-fade-in">
        ...
        <h1 className="text-4xl font-bold">Netzwerk-Informationen</h1>
        <p className="text-muted-foreground mt-2 max-w-2xl">
          Wichtige Informationen und Ressourcen zu deinem Heimnetzwerk, Geräten und Konfiguration.
        </p>
      </div>
